...
import { FaUserCircle, FaEnvelope, FaLock, FaEye, FaEyeSlash, FaSignInAlt } from 'react-icons/fa';
...
const Login = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch("https://i-notebook-backend-tau.vercel.app/api/auth/login", {
                method: 'POST',
                headers: {
                ...
                <div className="col-md-6">
                    ...
                    >
                        ...
                        <motion.div className="text-center mb-4" variants={itemVariants}>
                            ...
                            >
                                Login to <span style={{ color: 'var(--primary-color)' }}>iNotebook</span>
                            </motion.h2>
                            <motion.p 
                                variants={itemVariants}
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <motion.div className="text-center" variants={itemVariants}>
                                <p className="mb-0" style={{ color: 'var(--text-secondary)' }}>
                                    Don't have an account? <Link to="/signup" className="text-decoration-none" style={{ color: 'var(--primary-color)', fontWeight: '600' }}>Sign up</Link>
                                </p>
                            </motion.div>
                        </form>
                    </motion.div>
